...
const ManageOrders = () => {
	...
	return (
		<section id="manage_orders">
			...
			<div className="all-orders grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-y-12 sm:gap-y-8 sm:gap-x-4 md:gap-10 lg:gap-x-4 lg:gap-y-6 xl:gap-8">
				{
