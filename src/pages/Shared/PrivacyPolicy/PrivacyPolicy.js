...
const PrivacyPolicy = () => {
	return (
		<div id="privacy_policy" className="py-8 lg:py-10">
			<div className="container max-w-screen-lg">
				<h2 className="text-xl uppercase mb-8">Privacy Policy</h2>
				...
				<div className="space-y-6">
					...
					<ul>
						...
						<li>
							<p>
								...
								in this Agreement) refers to Travelmoi, Kushtia, Bagladesh.
							</p>
						</li>
						<li>
							<p>
						...
						<li>
							<p>
								<strong>Website</strong> refers to Travelmoi, accessible from{' '}
								<a
									href="https://travelmoi-react-app.web.app/"
									rel="external nofollow noopener noreferrer"
									target="_blank"
								>
									https://travelmoi-react-app.web.app/
								</a>
							</p>
						</li>
						<li>
					...
					<ul>
						<li>By email: ranafazrabbi@gmail.com</li>
					</ul>
				</div>
			</div>
		</div>
